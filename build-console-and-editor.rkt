...
(define-runtime-path closure-dir (build-path "node_modules" "google-closure-library"))
; (define-runtime-path closure-zip-path (build-path "externals" "closure-library-20111110-r1376.zip"))

(define-runtime-path codemirror-src-dir (build-path "codemirror5"))
(define-runtime-path codemirror-dest-dir (build-path "static" "js" "codemirror-dest"))
